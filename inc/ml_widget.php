...
function ml_in_widget_form_impl(&$wp_widget, &$return, $instance) {
	...
	?>
		<p><label for="<?php echo $title_id ?>"><?php echo __('Title') . ' (' . $lang_name . '):'; ?></label>
...
<?php
	...
	?>
		<p<?php echo version_compare( get_bloginfo('version'), '4.8', '<' ) ? '':' style="display:none;"' ?>><label for="<?php echo $text_id ?>"><?php echo __( 'Content' . ' (' . $lang_name . '):' ); ?></label>
...
<script>
	...
	?>
		<p style="<?php echo $eleStyle ?>"><label for="<?php echo $contentt_id ?>"><?php echo __( 'Content' . ' (' . $lang_name . '):' ); ?></label>
